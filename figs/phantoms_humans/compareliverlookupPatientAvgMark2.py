...
plt.errorbar(0.8094, 0.8471, yerr=0.0057, xerr=0.0064, elinewidth=3, marker='s', ms=8, color='cyan', label='E1786-1')
plt.errorbar(1.9714, 2.0150, yerr=0.0202, xerr=0.0180, elinewidth=3, marker='s', ms=8, color='magenta', label='E1787-1')
...
leg = ax.legend(scatterpoints = 1, numpoints=1, loc = 4, fontsize=18, framealpha=0.0)
...
plt.ylabel('SWS$_{vel}$ (m/s)', fontsize = 32, color='k')
plt.xlabel('SWS$_{disp}$ (m/s)', fontsize = 32, color='k')
plt.savefig('phantoms_humans.png', dpi=400)
